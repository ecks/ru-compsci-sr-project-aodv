...
const char aodv_rte_pr_c [] = "MIL_3_Tfile_Hdr_ 160A 30A modeler 7 4D0524D4 4D0524D4 1 Robilablap-00 student 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 277a 1                                                                                                                                                                                                                                                                                                                                                                                                    ";
#include <string.h>
...
aodv_rte_route_table_entry_update (IpT_Dgram_Fields* ip_dgram_fd_ptr, IpT_Rte_Ind_Ici_Fields* intf_ici_fdstruct_ptr,
	...
	switch(geo_routing_type)
	{
		...
		case AODV_TYPE_GEO_ROTATE:
			...
			//Updating the table can be the same as the one for GEO_ROTATE_01.
...
aodv_rte_route_table_entry_from_hello_update (IpT_Dgram_Fields* ip_dgram_fd_ptr, AodvT_Packet_Option* tlv_options_ptr)
	...
	switch(geo_routing_type)
	{
		...
		case AODV_TYPE_GEO_ROTATE:
			//LAR TODO!
			//UPDATING IS THE SAME? MKA 12/02/10
		case AODV_TYPE_LAR_DISTANCE:
			//LAR TODO!
			//LAR SCHEME 2
			//UPDATING IS THE SAME? MKA 12/02/10
